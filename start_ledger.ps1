...
# Description: Automates ledger service startup with virtual environment activation

Write-Host "Starting Ledger Service..." -ForegroundColor Green

# Navigate to ledger directory
Set-Location "ledger/backend"
